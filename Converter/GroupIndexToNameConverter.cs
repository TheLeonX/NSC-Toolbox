...
{
    public class GroupIndexToNameConverter : IMultiValueConverter
    {
        // values[0] = GroupID (int)
        // values[1] = GroupList (ObservableCollection<NUS3_GRP_Entry_Model>)
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                var item = list[idx];
                // пытаемся получить Name через reflection / cast
